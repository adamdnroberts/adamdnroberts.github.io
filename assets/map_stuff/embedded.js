!function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("mapbox-gl")) : "function" == typeof define && define.amd ? define(["exports", "mapbox-gl"], t) : t((e = e || self).bundle = {}, e.mapboxgl)
}
(this, (function (e, t) {
        "use strict";
        function n(e) {
        ...
        function _(e) {
            ...
            return (window.crypto ? window.crypto : window.msCrypto).getRandomValues(t),
            Array.from(t, k).join("")
        }
        function x(e, t) {
        ...
        j = "undefined" != typeof window && null != window.customElements && void 0 !== window.customElements.polyfillWrapFlushCallback,
        P = function (e, t) {
        ...
        D = function e(t, n) {
            ...
            this.parts = [],
            this.element = n;
            for (var r = [], o = [], s = document.createTreeWalker(n.content, 133, null, !1), a = 0, u = -1, l = 0, c = t.strings, h = t.values.length; l < h; ) {
                var d = s.nextNode();
                if (null !== d) {
                    if (u++, 1 === d.nodeType) {
                        if (d.hasAttributes()) {
                        ...
                        "TEMPLATE" === d.tagName && (o.push(d), s.currentNode = d.content)
                    } else if (3 === d.nodeType) {
                        var k = d.data;
                        if (k.indexOf(I) >= 0) {
                            for (var _ = d.parentNode, x = k.split(F), O = x.length - 1, S = 0; S < O; S++) {
                                var E = void 0,
                                M = x[S];
                                if ("" === M)
                                    E = H();
                                    ...
                                    var N = Q.exec(M);
                                    null !== N && V(N[2], "$lit$") && (M = M.slice(0, N.index) + N[1] + N[2].slice(0,  - "$lit$".length) + N[3]),
                            ...
                            "" === x[O] ? (_.insertBefore(H(), d), r.push(d)) : d.data = x[O],
                            l += O
                        }
                    } else if (8 === d.nodeType)
                        if (d.data === I) {
                            var T = d.parentNode;
                            null !== d.previousSibling && u !== a || (u++, T.insertBefore(H(), d)),
                            a = u,
                            this.parts.push({
                                type: "node",
                                index: u
        ...
        Z = function () {
            ...
            return o(e, [{
                        ...
                        key: "_clone",
                        value: function () {
                            for (var e, t = j ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0), n = [], i = this.template.parts, r = document.createTreeWalker(t, 133, null, !1), o = 0, s = 0, a = r.nextNode(); o < i.length; )
                                if (e = i[o], U(e)) {
                                    for (; s < e.index; )
                                        s++, "TEMPLATE" === a.nodeName && (n.push(a), r.currentNode = a.content), null === (a = r.nextNode()) && (r.currentNode = n.pop(), a = r.nextNode());
                                    if ("node" === e.type) {
                                        var u = this.processor.handleTextExpression(this.options);
                                        u.insertAfterNode(a.previousSibling),
                                        this.__parts.push(u)
                                    } else {
                                        var l;
                                        (l = this.__parts).push.apply(l, g(this.processor.handleAttributeExpressions(a, e.name, e.strings, this.options)))
                                    }
                                    o++
                                } else
                                    this.__parts.push(void 0), o++;
                            return j && (document.adoptNode(t), customElements.upgrade(t)),
                            t
                        }
                    }
                ]),
            ...
            return o(e, [{
                        ...
                        value: function () {
                            for (var e = this.strings.length - 1, t = "", n = !1, i = 0; i < e; i++) {
                                ...
                                var s = Q.exec(r);
                                t += null === s ? r + (n ? z : R) : r.substr(0, s.index) + s[1] + s[2] + "$lit$" + s[3] + I
                            }
        ...
        X = function () {
            ...
            return o(e, [{
                        key: "setValue",
                        value: function (e) {
                            e === C || G(e) && e === this.value || (this.value = e, B(e) || (this.committer.dirty = !0))
                        }
                    }, {
                        key: "commit",
                        value: function () {
            ...
            return o(e, [{
                        ...
                        value: function () {
                            if (null !== this.startNode.parentNode) {
                                ...
                                t !== C && (G(t) ? t !== this.value && this.__commitText(t) : t instanceof Y ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : J(t) ? this.__commitIterable(t) : t === L ? (this.value = L, this.clear()) : this.__commitText(t))
                            }
                        }
                    }, {
                        key: "__insert",
        ...
        q = function () {
            function e(t, n, r) {
                if (i(this, e), this.value = void 0, this.__pendingValue = void 0, 2 !== r.length || "" !== r[0] || "" !== r[1])
        ...
        $ = function (e) {
            ...
            function n(e, r, o) {
                var s;
                return i(this, n),
                (s = t.call(this, e, r, o)).single = 2 === o.length && "" === o[0] && "" === o[1],
                s
            }
            return o(n, [{
                        key: "_createPart",
                        ...
                        key: "_getValue",
                        value: function () {
                            return this.single ? this.parts[0].value : y(c(n.prototype), "_getValue", this).call(this)
                        }
                    }, {
                        key: "commit",
                        value: function () {
            ...
            return o(e, [{
                        ...
                        value: function () {
                            ...
                            if (this.__pendingValue !== C) {
                                ...
                                r && (this.__options = ie(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)),
                                this.value = t,
                                this.__pendingValue = C
                            }
                        }
        ...
        re = new(function () {
            ...
            return o(e, [{
                        ...
                        value: function (e, t, n, i) {
                            var r = t[0];
                            return "." === r ? new $(e, t.slice(1), n).parts : "@" === r ? [new ne(e, t.slice(1), i.eventContext)] : "?" === r ? [new q(e, t.slice(1), n)] : new K(e, t, n).parts
                        }
                    }, {
        ...
        function oe(e) {
            ...
            return void 0 === (n = t.keyString.get(i)) && (n = new D(e, e.getTemplateElement()), t.keyString.set(i, n)),
        ...
        ue = function (e, t, n) {
            var i = ae.get(t);
            void 0 === i && (P(t, t.firstChild), ae.set(t, i = new W(Object.assign({
                                templateFactory: oe
                            }, n))), i.appendInto(t)),
            i.setValue(e),
            i.commit()
        ...
        var he = function () {
            function e(t, n, r) {
                ...
                this.map = t,
                this.id = n.id,
                this.sourceId = "string" == typeof(o = n.source) || o instanceof String ? n.source : n.id,
                this.type = n.type,
            ...
            return o(e, [{
                        ...
                        key: "setAssignment",
                        value: function (e, t) {
                            this.setFeatureState(e.id, u(u({}, e.state), {}, {
                                    color: t
                                }))
                        }
                    }, {
        ...
        function fe(e, t, n) {
            return {
                units: new he(e, {
                    ...
                    type: "fill",
                    paint: {
                        "fill-color": ["case", ["boolean", ["feature-state", "hover"], !1], ["match", ["feature-state", "color"], 0, "#000000", "#777777"], ["match", ["feature-state", "color"], 0, "#202f24", "rgba(0, 0, 0, 0)"]],
                        "fill-opacity": .55
                    }
                }, n),
                unitsBorders: new he(e, {
                    id: "units-borders",
                    type: "line",
                    source: t.sourceLayer,
                    "source-layer": t.sourceLayer,
        ...
        me = function () {
            ...
            return o(e, [{
                        ...
                        value: function (e, t, n, i, r) {
                            ...
                            t.tileset.source.promoteId[t.tileset.sourceLayer] = t.idColumn.key;
                        ...
                        key: "hasExpectedData",
                        value: function (e) {
                            if (void 0 === e || void 0 === e.properties)
                                return !1;
                            var t,
                            n = w(this.columns);
                            try {
        ...
        var we = function () {
            ...
            return o(e, [{
                        ...
                        value: function (e) {
                            var t = this;
                            return le(Ae(), this.name, this.name, this.id, this.id, (function () {
                                    return e(t.id)
        ...
        Ne = function () {
            ...
            return o(e, [{
                        ...
                        key: "render",
                        value: function () {
                            return le(Se(), be(this.brush.radius, this.changeRadius, {
                                    title: "Eraser Size"
                                }))
                        }
                    }
        ...
        var je = function (e) {
            ...
            return o(n, [{
                        ...
                        value: function (e) {
                            ...
                            !0 === this.coloring ? this.colorFeatures() : y(c(n.prototype), "hoverOn", this).call(this, e)
                        }
                    }, {
                        key: "colorFeatures",
                        value: function () {
                            var e = this;
                            this.locked && !this.erasing ? this._colorFeatures((function (e) {
                            ...
                            try {
                                for (i.s(); !(t = i.n()).done; ) {
                                    ...
                                    if (e(r) && !r.state.home) {
                                        ...
                                        this.layer.setFeatureState(r.id, u(u({}, r.state), {}, {
                                                color: this.color,
                                                hover: !0
                                            })),
        ...
        (function (e) {
            ...
            return o(n, [{
                        ...
                        value: function () {
                            ...
                            this.hoveredFeatures.forEach((function (t) {
                                    e.layer.setFeatureState(t.id, u(u({}, t.state), {}, {
                                            hover: !1
                                        }))
                                })),
                        ...
                        value: function (e) {
                            ...
                            this.hoveredFeatures.forEach((function (e) {
                                    t.layer.setFeatureState(e.id, u(u({}, e.state), {}, {
                                            hover: !0
                                        }))
                                }))
                        }
            ...
            (function () {
                ...
                return o(e, [{
                            key: "hoverOff",
                            value: function () {
                                null !== this.hoveredFeature && (this.layer.setFeatureState(this.hoveredFeature.id, u(u({}, this.hoveredFeature.state), {}, {
                                            hover: !1
                                        })), this.hoveredFeature = null)
                            }
                        }, {
                            ...
                            value: function (e) {
                                ...
                                this.layer.setFeatureState(e.id, u(u({}, e.state), {}, {
                                        hover: !0
                                    }))
                            }
                        }, {
        ...
        Ce = function () {
            ...
            return o(e, [{
                        ...
                        value: function (e) {
                            ...
                            n !== this.state && (this.state = n, this.subscribers.forEach((function (e) {
        ...
        Ve = new WeakMap,
        Ue = new WeakMap,
        He = (Pe = function (e, t, n) {
            var i;
            return void 0 === n ? n = t : void 0 !== t && (i = t),
            function (t) {
                if (!(t instanceof W))
                ...
                for (var p = 0, y = a.length - 1, m = 0, g = c.length - 1; p <= y && m <= g; )
                    if (null === a[p])
                        p++;
                    else if (null === a[y])
                        y--;
                    ...
                    else if (void 0 === o && (o = De(h, m, g), s = De(u, p, y)), o.has(u[p]))
                        if (o.has(u[y])) {
                            var b = s.get(h[m]),
                            A = void 0 !== b ? a[b] : null;
                            if (null === A) {
                                ...
                                l[m] = Ie(A, c[m]), Re(t, A, a[p]), a[b] = null;
                            m++
                        } else
                            Fe(a[y]), y--;
                    else
        ...
        var ze = function () {
            ...
            return o(e, [{
                        ...
                        value: function (e) {
                            ...
                            this.store.dispatch(E.selectTool({
                                    id: e
                                }))
                        }
                    }, {
                        key: "addTool",
                        value: function (e) {
                            void 0 !== e.options && (e.options.renderToolbar = this.renderCallback),
                        ...
                        value: function () {
                            var e,
                            t = this;
                            return le(Ze(), He(this.tools, (function (e) {
                                        return e.id
                                    }), (function (e) {
                                        return e.render(t.selectTool)
                                    })), (e = this.activeTool, le(Qe(), void 0 !== e.options ? "active" : "", void 0 !== e.options ? e.options.render() : "")))
                        }
                    }, {
                        key: "activeTool",
                        get: function () {
        ...
        var Ge = [function (e) {
                ...
                i.on("colorfeature", t.update),
                i.on("colorend", t.render);
                for (var r = 0, o = [new Be, new xe(i), new Me(i)]; r < o.length; r++) {
                    var s = o[r];
                    n.addTool(s)
                }
                n.selectTool("pan")
        ...
        Je = function () {
            function e(n, r, o) {
                ...
                fetch(r.graph).then((function (e) {
                        return e.json()
                    })).then((function (e) {
                        s.graph = e
                    })),
                fetch(r.url).then((function (e) {
                        return e.json()
                    })).then((function (e) {
            ...
            return o(e, [{
                        key: "render",
                        value: function () {
                            this.toolbarTarget && this.toolbar && ue(this.toolbar.render(), this.toolbarTarget)
                        }
                    }, {
                        key: "checkConnected",
                        value: function (e) {
                        ...
                        value: function (e, n) {
                            var i = this,
                            r = "https://api.mapbox.com/geocoding/v5/mapbox.places/".concat(encodeURIComponent(e), ".json") + "?autocomplete=false&limit=1&bbox=" + this.bounds[0][0] + "," + this.bounds[0][1] + "," + this.bounds[1][0] + "," + this.bounds[1][1] + "&access_token=".concat(t.accessToken);
                            fetch(r).then((function (e) {
                                    ...
                                    if (0 != e.features.length) {
                                        ...
                                        i.addressMarker = new t.Marker({
                                            color: "#ff4f49"
                                        }).setLngLat(r).addTo(i.map);
                                        var o = !1,
                                        s = function () {
                                            var e = this.map.queryRenderedFeatures(this.map.project(r), {
                                                layers: [this.state.units.id],
                                                validate: !1
                                            })[0];
                                            e && !o && (o = !0, this.homeBlock && (this.map.setFeatureState(this.homeBlock, u(u({}, this.homeBlock.state), {}, {
                                                            home: !1
                                                        })), this.clearNeighborhood.call(this, !1), console.log("INSIDE")), this.state.units.setAssignment(e, 0), this.state.plan.assignment[e.id] = 0, this.homeBlock = e, e.state.home = !0, this.map.setFeatureState(e, u(u({}, e.state), {}, {
                                                        home: !0
                                                    })), console.log("OUTSIDE"))
                                        }
                                        .bind(i);
                        ...
                        value: function () {
                            ...
                            this.homeBlock && t && (console.log(this.homeBlock.id), this.state.units.setAssignment(this.homeBlock, 0), this.state.plan.assignment[this.homeBlock.id] = 0)
                        }
                    }, {
                        key: "map",
                        get: function () {
        ...
        window.BivariateOverlay = function (e) {
            return {
                "fill-color": ["interpolate-hcl", ["linear"], ["case", ["==", e.denominator || ["get", "pop"], 0], e.midpt || .5, ["/", e.numerator || ["get", "gop"], e.denominator || ["get", "pop"]]], 0, e.colorLow || "rgb(30, 60, 210)", e.midpt || .5, "rgba(255, 255, 255, 0)", 1, e.colorHigh || "rgb(210, 30, 20)"],
                "fill-opacity": e.opacity || .375
            }
        },
        window.UnivariateOverlay = function (e) {
            return {
                "fill-color": ["interpolate-hcl", ["linear"], ["case", ["==", e.denominator || ["get", "pop"], 0], 0, ["/", e.numerator || ["get", "dem"], e.denominator || ["get", "pop"]]], 0, "rgba(255, 255, 255, 0)", 1, e.color || "#c0b010"],
                "fill-opacity": e.opacity || .375
            }
        },
